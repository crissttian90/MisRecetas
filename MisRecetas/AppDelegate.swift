...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //Customizar bar texto
        UINavigationBar.appearance().backgroundColor = UIColor(red: 240.0/255.0, green: 133.0/255.0, blue: 115.0/255.0, alpha: 1)
        
        //Customizar bar texto
        UINavigationBar.appearance().tintColor = UIColor(red: 120.0/255.0, green: 20.0/255.0, blue: 200.0/255.0, alpha: 1)
